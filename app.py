...
if st.session_state.active_scene == "hop1":
    ...
    <div class="status-banner-warning">
        <strong>⚠️ Controlled Benchmark:</strong> The 5.20 m/px image is generated by anti-aliased downsampling of the OHRC product, not acquired by TMC-2. This isolates scale invariance with all other variables held fixed. Cross-instrument OHRC↔TMC-2 validation is pending: no overlapping pair with sufficient illumination has been identified in the PRADAN archive.
    </div>
    """, unsafe_allow_html=True)
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    with c4:
        st.markdown(metric_card("Destriping", "75% Reduction", "Std: 0.370 → 0.093"), unsafe_allow_html=True)
    ...
    # ── Sub-step 2: Destriping & Proxy Variants
        ...
        <p style="color:#555; font-size:0.9rem;">
            ...
            We engineered a per-band spatial mean normalization and pushbroom column median destriping filter, reducing stripe variance by 75% (column std: 0.370 → 0.093) while preserving real lunar terrain structure across columns.
        </p>
        """, unsafe_allow_html=True)
        ...
        st.markdown("""
        <div class="presenter-box">
            <strong>💡 Presenter's Note for Evaluators:</strong> Dividing each band by its spatial mean normalizes solar spectral irradiance across wavelengths. Subtracting only the median column offset with a weakened filter (α = 0.75) suppresses sensor striping while leaving non-zero residual column variance (0.093) to protect real lunar terrain topography.
        </div>
        """, unsafe_allow_html=True)
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    <div style="display:grid; grid-template-columns: 1fr 1fr; gap: 1.2rem; margin-bottom: 1.5rem;">
        ...
        <div style="background:white; border:1px solid #E8E5DF; border-radius:10px; padding:1.2rem;">
            ...
            <p style="color:#555; font-size:0.88rem; line-height:1.6;">
                Evaluated on confirmed North Polar overlapping pair (<code>89.7086°N, 5.0764°E</code>). Pushbroom destriping reduces stripe variance by 75% (std 0.370 → 0.093), while automated gating prevents spurious registrations when terrain contrast is insufficient.
            </p>
        </div>
        <div style="background:white; border:1px solid #E8E5DF; border-radius:10px; padding:1.2rem;">
